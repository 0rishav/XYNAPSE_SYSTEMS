...
const PASSWORD_RESET_SECRET = process.env.PASSWORD_RESET_SECRET || ACCESS_TOKEN_SECRET;
const PASSWORD_RESET_TOKEN_EXPIRY = process.env.PASSWORD_RESET_TOKEN_EXPIRY || "10m";
...
export class TokenService {
  ...
  static async generateRefreshToken(user, { deviceName, ipAddress, userAgent }) {
    ...
    const expiresAt = new Date(Date.now() + parseDuration(REFRESH_TOKEN_EXPIRY));
