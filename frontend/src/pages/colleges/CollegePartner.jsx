        ...
        <div className="lg:col-span-2">
          <div className="rounded-3xl bg-white p-8 shadow-xl dark:bg-slate-900">
            ...
            <p className="mt-4 text-sm text-slate-600 dark:text-slate-400">
              ...
              is a long-term institutional collaboration model designed to help
              colleges, universities, and training institutes align their
            ...
            <p className="mt-3 text-sm text-slate-600 dark:text-slate-400">
              ...
              industry-driven curriculum, hands-on training, live projects, and
              career readiness programs directly on campus.
            </p>
